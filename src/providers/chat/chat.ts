...
export class ChatProvider {
  ...
  //Nous stockons d'abord le message dans un nœud sous l'ID utilisateur
  addnewmessage(msg) {
    if (this.buddy) {
  ...
  //Nous tirons simplement les nœuds sous le nœud enfant de la personne avec qui nous souhaitons discuter
  getbuddymessages() {
